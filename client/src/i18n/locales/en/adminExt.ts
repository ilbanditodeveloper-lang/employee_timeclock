  ...
  admin: {
    employees: {
      form: {
        ...
        scheduleEntryHint:
          "Set clock-in and optional clock-out per day. Choose continuous or split shift as needed.",
    ...
    hours: {
      ...
      registerTitle: "Hours log ({{count}} entries, {{duration}})",
    ...
    schedule: {
      workDay: "Work day",
      modeLabel: "Shift type",
      modeContinuous: "Continuous",
      modeSplit: "Split",
      entry: "Clock in",
      exitOptional: "Clock out (optional)",
      slot1: "Block 1",
      slot2: "Block 2",
      exitHint:
        "If you leave clock-out empty, it is calculated automatically (+8 h or until the next clock-in).",
    },
    timeclock: {
      voided: "Voided",
      corrected: "Corrected",
