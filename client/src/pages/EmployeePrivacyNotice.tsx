  ...
  const content = (
    ...
    <div className="space-y-4">
      ...
      {companyLegalQuery.isLoading ? (
        ...
        <p className="text-sm text-slate-600">Cargando información legal...</p>
      ...
      {embedded && (
        ...
        <div className="flex items-start gap-2 border-t pt-4">
          ...
          <Label htmlFor="read-notice" className="leading-snug text-sm">
            ...
            He leído la información sobre el tratamiento de mis datos personales (acuse de recibo

            electrónico, no consentimiento de control horario).
      ...
      {embedded && (
        ...
        >
          ...
          {accept.isPending ? "Guardando..." : "Continuar"}
